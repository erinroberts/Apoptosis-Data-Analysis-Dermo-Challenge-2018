...
```
![VI_PLOT9_PLOT10_BAD_REMOVED_combined_plotting](https://github.com/erinroberts/Apoptosis-Data-Analysis-Dermo-Challenge-2018/blob/master/Figures/VI_PLOT9_PLOT10_BAD_REMOVED_combined_plotting.png)
...
nrow(VI_DAY50_PLOT3_P1_GATE_BAD_REMOVED)
# 74 samples
```
...
```
![total_granular_agranular_day50](https://github.com/erinroberts/Apoptosis-Data-Analysis-Dermo-Challenge-2018/blob/master/Figures/total_granular_agranular_day50.png)
...
```{r total_aov, echo=TRUE}

total_via_aov <- aov(compiled_day7_day_50_all_agranular_granular$Arcsine ~ compiled_day7_day_50_all_agranular_granular$GROUP, data=compiled_day7_day_50_all_agranular_granular)
summary(total_via_aov)
