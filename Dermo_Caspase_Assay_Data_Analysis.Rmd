...
```{r apoptosis_granular_compared_1, echo=TRUE}

CAS_PLOT4_granular_quad_plot_GATE_ADDED_plot <- ggplot(CAS_PLOT4_granular_quad_plot_GATE_ADDED, aes(x=GROUP, y=PERCENT_OF_THIS_PLOT,fill=GATE)) + geom_boxplot() + ggtitle("Percent of Granular Caspase-dependent Apoptotic, \n Necrotic, and Live Hemocytes") + ylab("Percent of Granular Hemocyte Events") + scale_fill_manual(name="Hemocyte Status", labels=c("Live Non-Apoptotic", "Live Caspase-dependent Apoptotic", "Dead", "Necrotic"), values=c("Q3_LL"="#738488","Q3_LR"="#8f50ab","Q3_UL"="#99c161", "Q3_UR"="#b65a49")) + facet_grid(.~FAMILY+GROUP, scales="free") 
ggsave("./Figures/CAS_PLOT4_granular_quad_plot_GATE_ADDED_plot.png", plot=CAS_PLOT4_granular_quad_plot_GATE_ADDED_plot)
```
![CAS_PLOT4_granular_quad_plot_GATE_ADDED_plot](https://github.com/erinroberts/Apoptosis-Data-Analysis-Dermo-Challenge-2018/tree/master/Figures/CAS_PLOT4_granular_quad_plot_GATE_ADDED_plot.png)

# LIVE Apoptotic Agranular hemocytes compared to Live and Necrotic hemocytes
```{r apoptosis_granular_compared, echo=TRUE}

CAS_PLOT7_agranular_quad_plot_GATE_ADDED_plot <- ggplot(CAS_PLOT7_agranular_quad_plot_GATE_ADDED, aes(x=GROUP, y=PERCENT_OF_THIS_PLOT,fill=GATE)) + geom_boxplot() + ggtitle("Percent of Agranular Caspase-dependent Apoptotic, \n Necrotic, and Live Hemocytes") + ylab("Percent of Agranular Hemocyte Events") + scale_fill_manual(name="Hemocyte Status", labels=c("Live Non-Apoptotic", "Live Caspase-dependent Apoptotic", "Dead", "Necrotic"), values=c("Q4_LL"="#738488","Q4_LR"="#8f50ab","Q4_UL"="#99c161", "Q4_UR"="#b65a49")) + facet_grid(.~FAMILY+GROUP, scales="free") 
ggsave("./Figures/CAS_PLOT7_agranular_quad_plot_GATE_ADDED_plot.png", plot=CAS_PLOT7_agranular_quad_plot_GATE_ADDED_plot)
```
![CAS_PLOT7_agranular_quad_plot_GATE_ADDED_plot](https://github.com/erinroberts/Apoptosis-Data-Analysis-Dermo-Challenge-2018/tree/master/Figures/CAS_PLOT7_agranular_quad_plot_GATE_ADDED_plot.png)
...
ggsave("./Figures/CAS_live_apoptotic_granular_agranular_plot.png", plot=CAS_live_apoptotic_granular_agranular_plot)

```
![CAS_live_apoptotic_granular_agranular_plot](https://github.com/erinroberts/Apoptosis-Data-Analysis-Dermo-Challenge-2018/tree/master/Figures/CAS_live_apoptotic_granular_agranular_plot.png)
...
```{r live_apoptotic_challenged_day7, echo=TRUE}
...
### One Way Anova CAS_live_apoptotic_granular_agranular ###
```{r CAS_live_apoptotic_granular_agranular, echo=TRUE}
#Family A
...
write.csv(file="total_caspase_statistics_day7.csv", total_caspase_statistics)
```
...
DAY50_CAS_P1_hemocytes$SAMPLE_ID <- gsub("E-187-C", "E-189-C", DAY50_CAS_P1_hemocytes$SAMPLE_ID)
DAY50_CAS_P1_hemocytes$OYSTER_ID <- gsub("E-187", "E-189", DAY50_CAS_P1_hemocytes$OYSTER_ID)

DAY50_CAS_PLOT4_granular_quad_plot$SAMPLE_ID <- gsub("E-187-C", "E-189-C", DAY50_CAS_PLOT4_granular_quad_plot$SAMPLE_ID)
DAY50_CAS_PLOT4_granular_quad_plot$OYSTER_ID <- gsub("E-187", "E-189", DAY50_CAS_PLOT4_granular_quad_plot$OYSTER_ID)

DAY50_CAS_PLOT7_agranular_quad_plot$SAMPLE_ID <-  gsub("E-187-C", "E-189-C", DAY50_CAS_PLOT7_agranular_quad_plot$SAMPLE_ID)
DAY50_CAS_PLOT7_agranular_quad_plot$OYSTER_ID <- gsub("E-187", "E-189",DAY50_CAS_PLOT7_agranular_quad_plot$OYSTER_ID)

DAY50_CAS_PLOT8_granular_agranular$SAMPLE_ID <- gsub("E-187-C", "E-189-C", DAY50_CAS_PLOT8_granular_agranular$SAMPLE_ID)
DAY50_CAS_PLOT8_granular_agranular$OYSTER_ID <- gsub("E-187", "E-189", DAY50_CAS_PLOT8_granular_agranular$OYSTER_ID)

DAY50_CAS_PLOT10_live_dead$SAMPLE_ID <- gsub("E-187-C", "E-189-C", DAY50_CAS_PLOT10_live_dead$SAMPLE_ID)
DAY50_CAS_PLOT10_live_dead$OYSTER_ID <- gsub("E-187", "E-189", DAY50_CAS_PLOT10_live_dead$OYSTER_ID)
...
Caspase_assay_Samples_Remove_day50$SAMPLE_ID <- gsub("E-36-C", "E-30-C", APOPTOSIS_Samples_Remove_day50$SAMPLE_ID)
...
```{r compiled_graph, echo=TRUE}
DAY50_CAS_PLOT7_agranular_quad_plot_BAD_REMOVED$DAY <-"50"
DAY50_CAS_PLOT4_granular_quad_plot_BAD_REMOVED$DAY <-"50"
CAS_PLOT7_agranular_quad_plot_GATE_ADDED$DAY <- "07"
CAS_PLOT4_granular_quad_plot_GATE_ADDED$DAY <- "07"

DAY50_CAS_PLOT7_agranular_quad_plot_BAD_REMOVED_subset <- DAY50_CAS_PLOT7_agranular_quad_plot_BAD_REMOVED[,c("SAMPLE_ID", "FAMILY","PERCENT_OF_THIS_PLOT", "GATE","DAY","GROUP", "PLOT","Arcsine","DAY", "OYSTER_ID")]
DAY50_CAS_PLOT4_granular_quad_plot_BAD_REMOVED_subset <- DAY50_CAS_PLOT4_granular_quad_plot_BAD_REMOVED[,c("SAMPLE_ID", "FAMILY","PERCENT_OF_THIS_PLOT", "GATE","DAY","GROUP", "PLOT","Arcsine","DAY","OYSTER_ID")]
CAS_PLOT7_agranular_quad_plot_GATE_ADDED_subset <- CAS_PLOT7_agranular_quad_plot_GATE_ADDED[,c("SAMPLE_ID", "FAMILY","PERCENT_OF_THIS_PLOT", "GATE","DAY","GROUP", "PLOT","Arcsine","DAY","OYSTER_ID")]
CAS_PLOT4_granular_quad_plot_GATE_ADDED_subset <- CAS_PLOT4_granular_quad_plot_GATE_ADDED[,c("SAMPLE_ID", "FAMILY","PERCENT_OF_THIS_PLOT", "GATE","DAY","GROUP", "PLOT","Arcsine","DAY","OYSTER_ID")]
...
#BEST PLOT 
  ...
  facet_grid(DAY~PLOT+FAMILY, scales="free") + scale_fill_manual(name="Hemocyte Type", labels=c("Live Non-Apoptotic Aranular","Live Apoptotic Agranular", "Dead Apoptotic Agranular", "Necrotic Agranular", "Live Non-Apoptotic Granular", "Live Apoptotic Granular", "Dead Apoptotic Granular", "Necrotic Granular"), values=c("Q4_LL"="#7d7f77","Q4_LR"="#33362f", "Q4_UL"="#d1c9b8","Q4_UR"="#accccf","Q3_LL"="#488772", "Q3_LR"="#52d79b","Q3_UL"="#a5d4c1","Q3_UR"="#62dccc")) + theme(text=element_text(size=20))+ theme(legend.text = element_text(size=20)) + theme(axis.text.x = element_text(hjust=0.5,angle = 45))
 
```

#### Calculate Summary Statistics Day 50 ####
```{r summary_stats, echo=TRUE}

# Summary Statistics for Percentages 
total_caspase_statistics_day50 <- summarySE(data=DAY50_CAS_live_apoptotic_combined, "PERCENT_OF_THIS_PLOT", groupvars=c("GROUP", "GATE","FAMILY"))
write.csv(file="total_caspase_statistics_day50.csv", total_caspase_statistics_day50)
```