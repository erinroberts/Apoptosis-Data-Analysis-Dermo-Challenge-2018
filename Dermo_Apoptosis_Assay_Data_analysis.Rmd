...
DAY50_APOP_PLOT4_GRANULAR_QUAD_PLOT$PERCENT_OF_THIS_PLOT <- as.numeric(gsub("\\%", "", DAY50_POP_PLOT4_GRANULAR_QUAD_PLOT$PERCENT_OF_THIS_PLOT))
...
```{r Day50_necrotic_apoptotic_agranular_oneway_, echo=TRUE}
DAY50_necrotic_granular_BAD_REMOVED_CHALLENGE <- 
