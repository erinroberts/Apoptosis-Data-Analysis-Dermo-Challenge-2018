...
### Plotting with arcsine transformed and untransformed values
...
VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine <- VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix # create new data frame with the old data
...
VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Dead_agranular_ratio_arcsine <- transf.arcsin(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Dead_agranular_ratio)
VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Live_granular_ratio_arcsine <- transf.arcsin(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Live_granular_ratio)
VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Live_agranular_ratio_arcsine <- transf.arcsin(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Live_agranular_ratio)
VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q2_UL_Granular_Necrotic_arcsine <- transf.arcsin(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q2_UL_Granular_Necrotic*0.01)
VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q2_UR_Granular_Dead_Apoptotic_arcsine <- transf.arcsin(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q2_UR_Granular_Dead_Apoptotic*0.01)
VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q2_LL_Granular_Live_arcsine <- transf.arcsin(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q2_LL_Granular_Live*0.01)
VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q2_LR_Granular_Live_Apoptotic_arcsine <- transf.arcsin(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q2_LR_Granular_Live_Apoptotic*0.01)
VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q1_UL_Agranular_Necrotic_arcsine <- transf.arcsin(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q1_UL_Agranular_Necrotic*0.01)
VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q1_UR_Agranular_Dead_Apoptotic_arcsine <- transf.arcsin(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q1_UR_Agranular_Dead_Apoptotic*0.01)
VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q1_LR_Agranular_Live_Apoptotic_arcsine <- transf.arcsin(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q1_LR_Agranular_Live_Apoptotic*0.01)


# Assess distribution of all variables prio to arcsine transformation and then after
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$Dead_agranular_ratio)
...
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
  ...
  # looks somewhat negative binomial?

plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$Dead_granular_ratio)
  # non normal, perhaps gamma
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Dead_granular_ratio_arcsine)
# looks negative binomial now 

plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$Live_granular_ratio)
...
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$ Live_agranular_ratio)
  # not normal, perhaps uniform
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
...
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$Q2_UL_Granular_Necrotic)
  # not normally distributed
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q2_UL_Granular_Necrotic_arcsine)

plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$Q1_UL_Agranular_Necrotic)
  # not normally distributed...
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q1_UL_Agranular_Necrotic_arcsine)

plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID,
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$Q2_UR_Granular_Dead_Apoptotic)
  # not normal
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q2_UR_Granular_Dead_Apoptotic_arcsine)

plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$Q2_LL_Granular_Live)
  # not normally distributed 
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID,
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q2_LL_Granular_Live_arcsine)

plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$Q2_LR_Granular_Live_Apoptotic)
...
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$Q1_UR_Agranular_Dead_Apoptotic)
  # no distribution
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID,
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q1_UR_Agranular_Dead_Apoptotic_arcsine)

plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$Q1_LL_Agranular_Live)
  # no distribution 
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID,
VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q1_LL_Agranular_Live_arcsine)

plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$Q1_LR_Agranular_Live_Apoptotic)
plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix$SAMPLE_ID, VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_matrix_arcsine$Q1_LR_Agranular_Live_Apoptotic_arcsine)
# perhaps a beta distribution

plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_CASPASE_subset$OYSTER_ID, 
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_CASPASE_subset$Q3_LR_Granular_Live_Caspase_Dependent_Apoptotic) 
  # perhaps normally distributed? won't let me plot the individual oyster ID's

plot(VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_CASPASE_subset$FAMILY,
     VI_DAY7_DAY50_LIVE_combined_merged_total_QPCR_formatted_fixed_APOP_CASPASE_subset$Q4_LR_Agranular_Live_Caspase_Dependent_Apoptotic)
